...
BASE_OUT=/root/feihong/FastWAM/evaluate_results/libero_endpoint_sanity_T10/endpoint_sanity_20260715_episodes
SUITE=libero_10
TASK_ID=0
TRIALS=50
mkdir -p "${BASE_OUT}"
...
import json
base=Path('/root/feihong/FastWAM/evaluate_results/libero_endpoint_sanity_T10/endpoint_sanity_20260715_episodes')
