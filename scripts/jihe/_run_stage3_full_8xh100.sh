...
case "${BENCHMARK_KEY}" in
  libero)
    ...
    DATASET_EXPOSURE="10.000 epochs / 2,734,560 windows"
    SAVE_EVERY="1899"
    KEEP_LAST="32"
    EXPECTED_TRAIN_TIME="36-43 hours"
  ...
  robotwin)
    ...
    DATASET_EXPOSURE="0.1597 epoch / 960,000 windows"
    SAVE_EVERY="500"
    KEEP_LAST="41"
    EXPECTED_TRAIN_TIME="84-96 hours"
