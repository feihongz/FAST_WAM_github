...
RUN_ID="${RUN_ID:-2026-07-01_00-57-01}"
...
require_path "${PROJECT_ROOT}/scripts/jihe/train_robotwin_unified_two_action_8xh100.sh"
...
export WANDB_DIR="${WANDB_DIR:-${FASTWAM_STORAGE_ROOT}/FastWAM/formal_runs/FAST_WAM_github/robotwin_unified_two_action_3cam_384_1e-4/${RUN_ID}/wandb}"
...
WANDB_GROUP="${USER_WANDB_GROUP:-${WANDB_GROUP:-robotwin_unified_two_action_3cam_384_1e-4}}"
WANDB_RUN_NAME="${USER_WANDB_RUN_NAME:-${WANDB_RUN_NAME:-robotwin_unified_two_action_3cam_384_1e-4_${RUN_ID}}}"
...
HYDRA_ARGS=(
  ...
  "output_dir=${FASTWAM_STORAGE_ROOT}/FastWAM/formal_runs/FAST_WAM_github/robotwin_unified_two_action_3cam_384_1e-4/${RUN_ID}"
  "batch_size=4"
