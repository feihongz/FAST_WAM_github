...
TASK_NAME="libero_unified_shared_2cam224_1e-4"
...
HYDRA_ARGS+=("+data.train.pretrained_norm_stats=./checkpoints/fastwam_release/libero_uncond_2cam224_dataset_stats.json")
HYDRA_ARGS+=("$@")
