...
[[ -f /root/feihong/FastWAM/formal_runs/FAST_WAM_github/robotwin_unified_shared_3cam_384_1e-4/2026-07-01_00-51-30/checkpoints/weights/latest.pt ]] || fail "Missing locked RoboTwin base checkpoint"
[[ -f /root/feihong/FastWAM/datasets/robotwin2.0/dataset_stats.json ]] || fail "Missing locked RoboTwin normalization stats"
[[ -f /root/feihong/FastWAM/checkpoints/Wan-AI/Wan2.2-TI2V-5B/Wan2.2_VAE.pth ]] || fail "Missing locked Wan2.2 VAE"
[[ -f /root/feihong/FastWAM/formal_runs/contracts/stage3/robotwin_train_6011575f_27225e/robotwin_stage3_data_manifest.json ]] || fail "Missing locked RoboTwin data manifest"
[[ -f /root/feihong/FastWAM/formal_runs/contracts/stage3/robotwin_train_6011575f_27225e/robotwin_text_cache_index.json ]] || fail "Missing RoboTwin text-cache index descriptor"
[[ -f /root/feihong/FastWAM/formal_runs/contracts/stage3/robotwin_train_6011575f_27225e/robotwin_text_cache_index.bin ]] || fail "Missing RoboTwin text-cache binary index"
if [[ -n "${RESUME_STATE}" ]]; then
