...
def _fastwam_creator_kwargs(
    ...
    return {
        ...
        "loss_lambda_video": float(loss.get("lambda_video", 1.0)),
        "loss_lambda_action": float(loss.get("lambda_action", 1.0)),
        "loss_alpha_wo": float(loss.get("alpha_wo", 0.5)),
        "loss_alpha_w": float(loss.get("alpha_w", 0.5)),
    }


def create_fastwam_unified_shared(
    model_id: str,
    tokenizer_model_id: str,
    video_dit_config,
    tokenizer_max_len: int = 512,
    ...
    from .models.wan22.fastwam_unified_shared import FastWAMUnifiedShared
...
def create_fastwam_unified_two_action(
    ...
    from .models.wan22.fastwam_unified_two_action import FastWAMUnifiedTwoAction
    ...
    return FastWAMUnifiedTwoAction.from_wan22_pretrained(**kwargs)
